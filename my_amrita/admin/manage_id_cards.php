...
<html lang="en-us">
<head>
    <meta charset="utf-8"><title>My Amrita - Student ID Cards</title>
...
<body>
    ...
    <div class="breadcrumb-bar"><a href="home.php">Home</a> <span class="sep">/</span> Student ID Cards</div>
    <div class="main-content">
        <div class="page-header">
            <h1><i class="fa fa-credit-card"></i> Student ID Cards</h1>
        ...
        <div class="card" style="background:#fff; border-radius:10px; padding:20px; border:1px solid #e8e8e8;">
            <?php if (empty($records)): ?>
                <div style="text-align:center; padding:40px; color:#888;">
                    <i class="fa fa-credit-card" style="font-size:40px; margin-bottom:10px; color:#ccc;"></i>
                                ...
                                <td>
                                    <form method="POST" style="display:inline-flex; gap:6px;">
                                        ...
                                        <select name="status" class="status-select">
                                            ...
                                            <option value="Active" <?php echo (isset($r['status']) && $r['status'] == 'Active') ? 'selected' : ''; ?>>Active (Unblocked)</option>
                                            <option value="Blocked" <?php echo (isset($r['status']) && $r['status'] == 'Blocked') ? 'selected' : ''; ?>>Blocked</option>
                                        </select>
