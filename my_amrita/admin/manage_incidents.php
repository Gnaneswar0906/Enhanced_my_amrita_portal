...
<html lang="en-us">
<head>
    <meta charset="utf-8"><title>My Amrita - Incidents</title>
...
<body>
    ...
    <div class="breadcrumb-bar"><a href="home.php">Home</a> <span class="sep">/</span> Incidents</div>
    <div class="main-content">
        <div class="page-header">
            <h1><i class="fa fa-exclamation-triangle"></i> Incidents</h1>
        ...
        <div class="card" style="background:#fff; border-radius:10px; padding:20px; border:1px solid #e8e8e8;">
            <?php if (empty($records)): ?>
                <div style="text-align:center; padding:40px; color:#888;">
                    <i class="fa fa-exclamation-triangle" style="font-size:40px; margin-bottom:10px; color:#ccc;"></i>
