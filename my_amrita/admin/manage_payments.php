...
<html lang="en-us">
<head>
    <meta charset="utf-8"><title>My Amrita - Manage Payments</title>
...
<body>
    ...
    <div class="breadcrumb-bar"><a href="home.php">Home</a> <span class="sep">/</span> Manage Payments</div>
    <div class="main-content">
        <div class="page-header">
            <h1><i class="fa fa-credit-card"></i> Manage Payments</h1>
